...
@section('content')
    <div x-data="{ loading: false, message: '' }" class="p-6">
        ...
        <div class="flex justify-between items-center mb-6">
            ...
            <button onclick="return window.location.href='{{ route('admin.backups.create') }}'"
                class="inline-flex items-center px-4 py-2 bg-indigo-600 hover:bg-indigo-700 text-white text-sm font-medium rounded-lg shadow transition relative">
        ...
        <div x-show="loading" style="display: none;"
            class="fixed inset-0 z-50 flex flex-col items-center justify-center bg-gray-900 bg-opacity-50 backdrop-blur-sm">
            <div
                class="bg-white dark:bg-gray-800 p-6 rounded-xl shadow-2xl flex items-center space-x-4 border border-gray-200 dark:border-gray-700">
                <svg class="animate-spin h-8 w-8 text-indigo-600 dark:text-indigo-400" xmlns="http://www.w3.org/2000/svg"
        ...
        <!-- Table Section (Light & Dark Mode Compatible) -->
        <div
                ...
                <tbody class="divide-y divide-gray-200 dark:divide-gray-800 bg-white dark:bg-gray-900">
                    @forelse($backups as $backup)
                        <tr class="hover:bg-gray-50 dark:hover:bg-gray-800/50 transition">
                            ...
                            <!-- File Size (Auto-converts to KB, MB, or GB) -->
                            ...
                            <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                                ...
                                <form action="{{ route('admin.backups.delete', $fileName) }}" method="POST" class="inline">
                                    @csrf
                                    @method('DELETE')
